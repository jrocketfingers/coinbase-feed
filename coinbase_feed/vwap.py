...
class VWAPFrame:
	...
	def __init__(self, initial_data: Union[Deque[Datapoint], None] = None, maxlen: Union[int, None] = None):
	...
	def add_datapoint(self, new_datapoint: Datapoint):
		...
		self.value_sum += new_datapoint.price * new_datapoint.size - old_datapoint.price * old_datapoint.size
